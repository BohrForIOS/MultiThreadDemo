//
//  BBDownloaderOperationManager.m
//  BBSDWebImage
//
...
/**
 下载操作管理类
 */
@interface BBDownloaderOperationManager ()
...
@implementation BBDownloaderOperationManager
...
- (void)downloadWithURLString:(NSString *)urlString finishedBlock:(void (^)(UIImage *image))finishedBlock{
    ...
    BBDownloadOperation *op = [BBDownloadOperation downloaderOperationWithURLString:urlString finishedBlock:^(UIImage *image) {
        //回调
        finishedBlock(image);
